...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  const updateUserProfileInFirestore = async (uid: string, data: Partial<AppUser>) => {
    ...
    try {
      ...
      // Optimistically update local state or let onAuthStateChanged handle it if relevant fields trigger it
  ...
  return (
    <AuthContext.Provider value={{ user, loading, login, logout, signup, sendVerificationEmail, updateUserProfileInFirestore }}>
      {children}
